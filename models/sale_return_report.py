...
class SaleReturnReport(models.Model):
    ...
    order_id = fields.Many2one('sale.return', 'Order #', readonly=True)
...
class SaleReturnReportProforma(models.AbstractModel):
    _name = 'report.sale.return.report_saleproforma'
